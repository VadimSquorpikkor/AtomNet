...
//----------------------------------------------------------------------------------------------------------------------
/**Для разворачивания спойлера (<details>) по его id. Работает только на текущей странице.
Можно подавать как один параметр, так и несколько, т.е. разворачивать один или несколько спойлеров
(несколько спойлеров бывает нужно, если необходимо перейти по якорю к содержимому спойлера,
расположенному внутри другого спойлера)*/
